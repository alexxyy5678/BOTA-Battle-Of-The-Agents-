export type AgentBattleSide = {
  ...
  dataSource: 'dexscreener' | 'polymarket' | 'fighter-profile' | 'ens-subgraph';
...
export type AgentBattle = {
  ...
  spectators: number;
  spectatorBantCredits?: number | null;
...
export type AgentBattleFeed = {
  ...
  updatedAt: string;
  sources: {
    marketData: 'dexscreener' | 'polymarket' | 'fighter-profiles' | 'ens-subgraph';
    note: string;
  };
};
