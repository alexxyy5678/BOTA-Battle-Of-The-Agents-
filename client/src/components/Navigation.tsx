          ...
          <div className="flex justify-between items-center h-12 md:h-16">
              ...
              {user && (
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 rounded-lg transition-colors text-xs bg-gradient-to-r from-yellow-400 to-yellow-600 shadow-[0_0_10px_rgba(250,204,21,0.5)] animate-pulse"
                  >
                    <Sparkles className="w-3 h-3 text-yellow-100" />
                    <span className="font-bold text-white">
                      {typeof balance === "object" && balance !== null
                        ? ((balance as any).points || 0).toLocaleString()
                        : "0"} BC
                    </span>
                  </button>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {user && (
                <button
                  onClick={() => handleNavigation("/points")}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg transition-colors bg-gradient-to-r from-yellow-400 to-yellow-600 shadow-[0_0_15px_rgba(250,204,21,0.5)] animate-pulse"
                >
        ...
        <Dialog open={showOnchainModal} onOpenChange={setShowOnchainModal}>
          <DialogContent className="sm:max-w-sm">
            ...
            <div className="flex justify-end gap-2 mt-2">
              ...
              <Button
                onClick={() => {
                  window.open("https://bota.bantah.fun", "_blank", "noopener,noreferrer");
