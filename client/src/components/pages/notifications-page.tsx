...
type NotificationsResponse = LiveNotification[] | { data?: LiveNotification[] }

function normalizeNotificationsResponse(response: NotificationsResponse | undefined): LiveNotification[] {
...
function getActionUrl(notification: LiveNotification) {
  ...
  const challengeCode = data.challengeCode ?? data.challenge_code
  ...
  if (typeof data.challengeUrl === 'string') return data.challengeUrl
...
export default function NotificationsPage() {
  ...
  const safeNotifications = normalizeNotificationsResponse(notificationsResponse)
